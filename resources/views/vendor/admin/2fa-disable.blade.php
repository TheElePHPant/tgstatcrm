...
<head>
    ...
    <title>Отключение двухфакторной авторизации</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg" style="font-weight: bold; color: red">Отключение двухфакторной авторизации</p>
        <p>Код подтверждения отправлен в Телеграм {{'@'.$username}}</p>
        <form action="{{ admin_url('2fa/disable') }}" method="post">
            ...
            <div class="col-xs-4">
                ...
                <br><br>
                <a href="{{admin_url('/')}}" class="btn btn-success">Оставить 2FA включенной</a>
